...
import TalentMatchLogo from '../../assets/images/Tech.png';
            ...
            <div className="navbar bg-base-100 px-5 md:px-28">
                <div className="navbar-start">
                    ...
                    <div className='mx-auto lg:mx-0 text-lg font-bold lg:text-3xl'>
                        <img src={TalentMatchLogo} className='h-40 w-72' alt="" />
                    </div>
                </div>
                ...
                <div className="navbar-end">
                    <button className='px-4 py-3 rounded text-white bg-primary text-sm'>Start Applying</button>
                </div>
            </div>
        </div>
